...
public class Profile extends AppCompatActivity {
    ...
    public void AddTSRClick() {
        ...
        edit.clear();
        edit.commit();
        Intent i = new Intent(Profile.this, tsr.class);
        startActivity(i);
        finish();
    }
    public void ViewV4() {
        ...
        edit.clear();
        edit.commit();
        Intent i = new Intent(Profile.this, V4Webbies.class);
        startActivity(i);
        finish();
    }
    public void logout() {
    ...
    public void NotifyBday() {
        ...
        try {
            ...
            if (con == null) {
                ...
                PendingIntent pendingIntent = PendingIntent.getActivity(Profile.this, 1, intent, 0);

                Notification.Builder builder = new Notification.Builder(Profile.this);
